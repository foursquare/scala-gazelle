// NOTE(scala-gazelle): embedded from https://github.com/apache/spark/blob/v4.0.0/mllib/src/main/scala/org/apache/spark/ml/regression/GeneralizedLinearRegression.scala
